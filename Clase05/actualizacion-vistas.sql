...
select * from profesores;
 ...
 -- Creamos una vista con los datos de todos los alumnos que tienen una 
 -- nota mayor o igual a 7, junto con el nombre del profesor que lo calificó
...
-- Notas
-- Si efectuamos un insert mediante la vista creada e insertamos un alumno con una nota 
-- inferior a 7 luego dicha fila se inserta en la tabla base pero no se visualiza en la vista:
...
-- Si agregamos ésta cláusula cuando creamos la vista luego no se harán inserciones, borrados 
-- o actualizaciones cuando los cambios no se visualizan en la vista.
...
-- Se genera error ya que luego este alumno no aparecerá en la vista
 ...
 -- Se actualiza correctamente ya que la nota es igual o superior a 7
 update vista_nota_alumnos_aprobados set nota=8
 where documento='30444444';
